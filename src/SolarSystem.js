    ...
    const animate = () => {
      renderer.setAnimationLoop(() => {
        ...
        scene.traverse(child => {
          if (child instanceof THREE.Mesh && !(child.parent instanceof THREE.RingGeometry)) {
        ...
        // Around-sun-rotation
        scene.traverse(child => {
          if (child instanceof THREE.Object3D && !(child.children.some(c => c instanceof THREE.RingGeometry))) {
            child.rotateY(generateWeightedRandomNumber());
          }
        });
